...
<br/>
<div class="row">
  <form action="articleUpdate" method="post" class="add-article-form">
    <div class="col-md-9">

      <div class="form-group">
        <label for="article-title" class="sr-only">标题</label>
        <input type="text" id="article-title" name="articleTitle" value="${articleInfo.articleTitle}"
               class="form-control" placeholder="在此处输入标题" required autofocus autocomplete="off">
      </div>
      <div class="form-group">
        <label for="article-content" class="sr-only">内容</label>
        <textarea class="form-control" name="articleContent"
                  style="height: 350px;">${articleInfo.articleContent}</textarea>
      </div>
